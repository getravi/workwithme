...
const GOOGLE_GEMINI_CLI_OAUTH_CLIENT_ID_ENV: &str = "GOOGLE_GEMINI_CLI_OAUTH_CLIENT_ID";
const GOOGLE_GEMINI_CLI_OAUTH_CLIENT_SECRET_ENV: &str = "GOOGLE_GEMINI_CLI_OAUTH_CLIENT_SECRET";
...
const GOOGLE_ANTIGRAVITY_OAUTH_CLIENT_ID_ENV: &str = "GOOGLE_ANTIGRAVITY_OAUTH_CLIENT_ID";
const GOOGLE_ANTIGRAVITY_OAUTH_CLIENT_SECRET_ENV: &str = "GOOGLE_ANTIGRAVITY_OAUTH_CLIENT_SECRET";
...
fn required_oauth_env(var: &str) -> Result<String> {
    std::env::var(var)
        .map_err(|_| Error::auth(format!("Missing required OAuth credential env var: {var}")))
}

fn google_gemini_cli_oauth_client_id() -> Result<String> {
    required_oauth_env(GOOGLE_GEMINI_CLI_OAUTH_CLIENT_ID_ENV)
}

fn google_gemini_cli_oauth_client_secret() -> Result<String> {
    required_oauth_env(GOOGLE_GEMINI_CLI_OAUTH_CLIENT_SECRET_ENV)
}

fn google_antigravity_oauth_client_id() -> Result<String> {
    required_oauth_env(GOOGLE_ANTIGRAVITY_OAUTH_CLIENT_ID_ENV)
}

fn google_antigravity_oauth_client_secret() -> Result<String> {
    required_oauth_env(GOOGLE_ANTIGRAVITY_OAUTH_CLIENT_SECRET_ENV)
}
...
pub async fn complete_google_gemini_cli_oauth(
    ...
    let client = crate::http::client::Client::new();
    let client_id = google_gemini_cli_oauth_client_id()?;
    let client_secret = google_gemini_cli_oauth_client_secret()?;
...
pub async fn complete_google_antigravity_oauth(
    ...
    let client = crate::http::client::Client::new();
    let client_id = google_antigravity_oauth_client_id()?;
    let client_secret = google_antigravity_oauth_client_secret()?;
    let oauth_response = exchange_google_authorization_code(
        &client,
